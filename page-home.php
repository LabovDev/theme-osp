	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<header >
			...
			<section class="wrap heroNav">
				<section class="bloc--50 heroNav__sctn heroNav__sctn--01"><a class="link link--heroNav" href="<?php bloginfo('url'); ?>/?page_id=14">Refuse Parts</a></section>
				<section class="bloc--50 heroNav__sctn heroNav__sctn--02"><a class="link link--heroNav" href="<?php bloginfo('url'); ?>/?page_id=405">Mixer Parts</a></section>
			</section> <!-- END .heroNav -->
